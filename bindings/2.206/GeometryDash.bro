...
class GameObject : CCSpritePlus {
	...
	TodoReturn disableObject() = ios 0x26bde4;
...
class GJBaseGameLayer : cocos2d::CCLayer, TriggerEffectDelegate {
	...
	void createTextLayers() = win 0x1ffa50, ios 0x1ed390;
	...
	TodoReturn updateCameraOffsetX(float, float, int, float, int, int) = win 0x225f20, imac 0x144270, m1 0x118618, ios 0x207a90;
	TodoReturn updateCameraOffsetY(float, float, int, float, int, int) = win 0x225fc0, imac 0x144370, m1 0x1186ec, ios 0x207b10;
...
class LevelTools {
	...
	static gd::string getAudioTitle(int) = win 0x307130, ios 0x1b4048;
...
class TextAlertPopup : cocos2d::CCNode {
	...
	static TextAlertPopup* create(gd::string, float, float, int, gd::string) = win 0x28b920, imac 0x2ab0c0, m1 0x24c288, ios 0x2f0d68;

	bool init(gd::string, float, float, int, gd::string) = win 0x28ba50, imac 0x2ab2e0, m1 0x24c4d0, ios 0x2f0ed4;
